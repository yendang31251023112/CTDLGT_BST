...
namespace Baitapdoan
{
    public partial class FormAdd : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Vui lòng nhập tên nhân viên", "Chấn chỉnh");
                return;
            }
            ...
            else
            {
                ...
                if (nvCu != null)
                {
                    ...
                    nvCu.NgaySinh = dtpNgaySinh.Value.Date;
                    ...
                    if (nvCu.NgayVaoLam.Date != dtpNgayVaoLam.Value.Date)
                    {
                        ...
                        _bstNhanViec.Update(idCanSua, null, null, null, null, dtpNgayVaoLam.Value.Date);
                    }

                    MessageBox.Show("Đã cập nhật hồ sơ !", "Thông báo");
                }
                else
                {
