        ...
        private void btnTimKiem_Click_1(object sender, EventArgs e)
        {
            ...
            switch (kieu)
            {
                ...
                case "Nhân Viên Cũ Nhất":
                    ...
                    if (oldest != null)
                    {
                        // Lấy cái ngày cũ nhất đó, đem đi quét một vòng xem có bao nhiêu người trùng ngày
                        List<Employee> listOldest = bst.FindByDate(oldest.NgayVaoLam.Date);
                        dgvNhanVien.DataSource = listOldest;
                    }
                    else
                    {
                ...
                case "Nhân Viên Mới Nhất":
                    ...
                    if (newest != null)
                    {
                        // Lấy cái ngày mới nhất đó, đem đi quét tương tự
                        List<Employee> listNewest = bst.FindByDate(newest.NgayVaoLam.Date);
                        dgvNhanVien.DataSource = listNewest;
                    }
                    else
                    {
                        MessageBox.Show("Hệ thống đang chưa có ai!", "Thông báo");
